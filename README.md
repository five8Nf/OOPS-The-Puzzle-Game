...
if entered portal will go to the pillar puzzle
left: pillar puzzle
player needs to get past a room filled with indestructable, poisonous, spiky, sharp, lava, deadly pillars
reward: a Wammer(weird hammer can hammer special tiles and wushrooms)
...
(can use pokemon hp + code)
will recieve a fire stone during the fight
recieve a earth stone
move on to a workshop
get ectoplasam to get ectoplasm (input chosen weapon)
get a ghost pet(Cat, Wolf, Patch of grass or a cloud of lead)
Can use pet to fight
chase sequence. 
ducks pile up behind player
king duck arives
drops earth stone and causes a big crater to form
excess ectoplasm forms a portal where the player teleports away. 
